...
export default function RoleList() {
                ...
                <div>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            setCurrentRights(typeof item.rights == 'string' ? JSON.parse(item.rights) : item.rights)
                        }}
                    />
                </div>
            )
    ...
    const deleteMethod: any = (item: IDataType) => {
        ...
        axios.delete(`/api/roles/delete/${item.id}`)
    }
    useEffect(() => {
    ...
    const handleOk = () => {
        ...
        axios({
            method: 'post',
            url: `/api/roles/updateRights`,
            headers: {
                'Content-Type': 'multipart/form-data'
            },
            data: {
                id: currentId,
                rights: JSON.stringify(currentRights)
            }
        })
    }
    const handleCancel = () => {
    ...
    return (
        <div>
            ...
            <Modal title="Basic Modal" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
                <Tree checkable onCheck={onCheck} checkStrictly checkedKeys={currentRights} treeData={rightList} />
            </Modal>
        </div>
    )
}
